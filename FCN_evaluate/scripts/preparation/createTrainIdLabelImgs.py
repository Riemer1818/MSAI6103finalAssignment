...
# cityscapes imports
from scripts.helpers.csHelpers import printError
from scripts.preparation.json2labelImg import json2labelImg
...
def main():
    ...
    if 'CITYSCAPES_DATASET' in os.environ:
        ...
        '''
    cityscapesPath='/home/msai/lidu0002/MSAI6103finalAssignment/datasets/cityscapes'
